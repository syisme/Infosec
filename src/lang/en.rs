...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Infosec Remote network..."),
        ("not_ready_status", "Infosec Remote Is Not ready. Please check your connection"),
        ...
        ("Slogan_tip", "Keselamatan Siber USM - Private Use Only"),
        ...
        ("install_tip", "Due to UAC, Infosec Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Infosec Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Infosec Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Infosec Remote \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", "Keselamatan Siber USM - Infosec, Private Server"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Infosec Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Infosec Remote Input] service."),
        ...
        ("config_microphone", "In order to speak remotely, you need to grant Infosec Remote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Infosec Remote."),
        ...
        ("verify_rustdesk_password_tip", "Verify Infosec Remote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Infosec Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Infosec Remote Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Infosec Remote from running properly as controlled side."),
        ...
        ("powered_by_me", "Infosec Remote Powered by RustDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Infosec Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep Infosec Remote background service"),
        ...
        ("About RustDesk", "About Infosec Remote"),
